  ...
  <a href="javascript:window.open(window.clickTag)">
  	<div class="ucareb" id="b970x250" data-text-delay="100" data-logo-delay="4000">
  		<div class="inner">
  			...
  			<div class="frames">
          <span data-timeline="500" class="network">
            <div>
              <img src="icon-network.png">
            </div>
            <p>Better network</p>
          </span>
  				<span data-timeline="1000" class="benefits">
            <div>
              <img src="icon-benefits.png">
            </div>
            <p>Better benefits</p>
          </span>
  				<span data-timeline="1500" class="savings">
            <div>
